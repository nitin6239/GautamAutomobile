...
const Hero = ({ theme = 'dark' }) => {
  ...
  return (
    <section id="home" className="relative min-h-[100dvh] flex items-center justify-center overflow-hidden sm:overflow-visible bg-transparent" style={{ background: 'transparent' }}>
      ...
      />
      <div className="relative z-10 text-center px-2 sm:px-6 max-w-4xl mx-auto pt-20 sm:pt-28 pb-8 sm:pb-10 flex flex-col justify-between min-h-[100dvh] sm:min-h-0 w-full overflow-visible">
